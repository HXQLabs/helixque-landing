          ...
          <div className="flex items-center justify-center px-6 lg:px-8">
            <div className="relative bg-white dark:bg-neutral-800 rounded-2xl p-4 md:p-6 w-full max-w-sm shadow-lg">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground text-sm md:text-base">Official Discord</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">Community hub</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="text-xs md:text-sm text-muted-foreground">Active members</div>
                  <span className="font-semibold text-foreground text-xs md:text-sm">Growing daily</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="text-xs md:text-sm text-muted-foreground">Discussions</div>
                  <span className="font-semibold text-foreground text-xs md:text-sm">Open & friendly</span>
                </div>
              </div>
              <div className="mt-4 pt-3 border-t border-neutral-200 dark:border-neutral-600">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                  <span className="text-xs text-muted-foreground">We'd love to have you there</span>
                </div>
              </div>
            </div>
          </div>
