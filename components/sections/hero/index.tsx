      ...
      <div className="mx-auto max-w-5xl py-16 sm:py-28">
        ...
        <div className="relative z-1 mx-auto max-w-3xl text-center">
          ...
          <p className="text-gray-600 dark:text-muted-foreground mx-auto mt-6 leading-7 font-normal text-balance sm:w-[660px] sm:text-[18px] md:mt-8">
            Connect with professionals worldwide through <strong>smart matching</strong> based on your skills, industry, and language. Practice interviews, get mentorship, and grow your network in a safe, structured environment.
          </p>
