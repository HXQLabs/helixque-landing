...
// 🚨 REMOVED: import { AnnouncementWrapper } from "./AnnouncementWrapper";

interface HeroSectionProps {
  // Accepts the server-rendered AnnouncementWrapper as a React Node
  announcementComponent: React.ReactNode; 
}

export const HeroSection = ({ announcementComponent }: HeroSectionProps) => {
    ...
    >
      <div className="mx-auto max-w-5xl py-16 sm:py-28">
        <div className="flex justify-center pb-8">
          {/* Renders the server-rendered component */}
