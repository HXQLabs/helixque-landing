import { announcementDocs } from "@/.source/index"
...
export default function AnnouncementsPage() {
  ...
  const docs = (announcementDocs as unknown as AnnouncementDoc[]) || []
  
  // Sort by date (newest first)
  const sortedAnnouncements = [...docs].sort((a, b) => {
  ...
  return (
    <div id="announcements" className="min-h-screen bg-background relative pb-20">
      {/* Page Title Section */}
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-10 pb-20">
        {sortedAnnouncements.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-2xl font-semibold mb-2">No Announcements Yet</h2>
                    ...
                    <div className="md:w-48 flex-shrink-0">
                      <div className="md:sticky md:top-24">
                        ...
                        {announcement.priority && (
                          <div
                            className={`inline-flex relative z-10 items-center justify-center px-3 py-1 text-xs font-medium rounded-full ${getPriorityColor(
                              announcement.priority
                            )}`}
                          >
